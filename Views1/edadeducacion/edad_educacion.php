                    ...
                    <?php
                      ...
                      <div class="col-xs-6 col-sm-4 col-md-4 col-lg-5">
                        ...
                        <?php if ($filas > 0) {?>
                          ...
                          <table id="tablaEdadEducacion" name="tabla" class="table table-bordered col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <thead>
                              <tr style="background-color: #b3434375">  
                                <td><center><strong>Nivel educativo</strong></center></td>
                                ...
                                <td><center><strong>De 85 a 150 años</strong></center></td>
                            ...
                            <tbody>
                              ...
                              <tr bgcolor="#DAD2D9">
                                <td><center><?php echo $row['edu_descripcion']; ?></center></td>
...
<script type="text/javascript">
      $('#buscar').on('click', function(event) {
        ...
        if (fecha1 == '') {
          ...
          $.ajax({
            url: '<?php echo URL; ?>edadeducacion/edad_educacion',
            type: 'POST',
            dataType: 'html',
 ...
 <script>$(document).ready(function() {
    ...
    {
      extend: 'excelHtml5',
      title: 'Edad - educacion <?php if($_POST){ echo 'desde '.date("d/m/Y", strtotime($_POST['fecha1'])).' hasta '.date("d/m/Y", strtotime($_POST['fecha2'])); } ?>',
      className: 'btn',
      text: "Excel"
  },
  {
...
{
  extend: 'print',
  title: '<H2>Edad - educacion <?php if($_POST){ echo 'desde '.date("d/m/Y", strtotime($_POST['fecha1'])).' hasta '.date("d/m/Y", strtotime($_POST['fecha2'])); } ?></H2><H5>Registro Único de Casos de Violencia contra las Mujeres (RUCVM)</H5><BR/>',
  className: 'btn',
  text: "Imprimir"
},
 {
