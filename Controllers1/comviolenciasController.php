...
//use Models\Seccion as Seccion;
	...
	class comviolenciasController{
            
            private $comviolencias;
            private $ficha31;
            //private $seccion;
            ...
            public function com_violencia(){
                ...
                if(!$_POST){
                    ...
                    if($_SESSION['idinstitucion'] == 12){
                        $datos = $this->ficha31->com_violenciasDep();
                    }else{
                        $datos = $this->ficha31->com_violencias();
                    }
                    return $datos;
                }
	        }
}
    $ficha31 = new comviolenciasController();
?>