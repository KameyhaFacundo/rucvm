    ...
    $(function () {
      ...
      // Create the chart
        ...
        ?>
          ...
          title: {
            text: 'Casos de violencia contra las mujeres registrados e informados, según cantidad de fichas por año, en la provincia de Tucumán. Período: 01/01/2000 - <?php echo date("d/m/Y"); ?>.',
           style: { 
                 fontSize: '14px', 
          ...
          yAxis: {
            title: {
              text: 'Cantidad total de fichas por año'
            }
          ...
          tooltip: {
            ...
            pointFormat: '<span style="color:{point.color}">{point.name}</span>: <b>{point.y} fichas</b>'
          },
        ...
        ?>
          ...
          xAxis: {
            ...
            <?php
                $filas = count($anio1);
                for($i=0;$i<$filas;$i++){ 
                   if($i == ($filas-1)){echo "'".$anio1[$i]."'";}else{ echo "'".$anio1[$i]. "',"; } 
           } ?>
                  ]
          },
          yAxis: {
          ...
          tooltip: {
            ...
            pointFormat: '{series.name}: {point.y} fichas<br/>Total: {point.stackTotal} fichas'
          },
          plotOptions: {
            column: {
              stacking: 'normal',
            ...
            <div class="card-body">
              <form id="enviar" name="enviar" role="form" class="form-horizontal" enctype="multipart/form-data"  method="post" action="">
                ...
                <?php if($filas > 0){ ?>
                  ...
                  for($i=0;$i<$filas;$i++){
                      ?>
                  <div class="card col-sm-5 col-md-4 col-lg-3 ml-2 mt-3 border-light colorborde" style="max-width: 20rem;">
                    <div class="card-body text-white colorfondo">
                      <i class="fa fa-users fa-5x"></i><h1 align="right"><?php echo $anio1[$i];?></h1>    
                    </div>
                    <a href="por_cantidades_mes?anio=<?php echo $anio1[$i]; ?>">
