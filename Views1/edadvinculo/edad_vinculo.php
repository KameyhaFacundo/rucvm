  ...
  <head>
    ...
    <script type="text/javascript">
      window.onload=function(){
        document.getElementById("op43").style.color = 'white';
      }
    </script>
  </head>
                  ...
                  <div class="form-row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <div class="form-label-group">
                        <b>Edad - vínculo <?php if($_POST){ echo 'desde '.date("d/m/Y", strtotime($_POST['fecha1'])).' hasta '.date("d/m/Y", strtotime($_POST['fecha2'])); } ?></b>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <?php
                      ...
                      <div class="col-xs-6 col-sm-4 col-md-4 col-lg-5">
                        ...
                        <?php if ($filas > 0) {?>
                          ...
                          <table id="tablaEdadVinculo" name="tabla" class="table table-bordered col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <thead>
                              <tr style="background-color: #b3434375">  
                                <td><center><strong>Vínculo con el agresor</strong></center></td>
                                <td><center><strong>De 14 a 24 años</strong></center></td>
                                <td><center><strong>De 25 a 34 años</strong></center></td>
                                <td><center><strong>De 35 a 44 años</strong></center></td>
                                <td><center><strong>De 45 a 54 años</strong></center></td>
                                <td><center><strong>De 55 a 64 años</strong></center></td>
                                <td><center><strong>De 65 a 74 años</strong></center></td>
                                <td><center><strong>De 75 a 84 años</strong></center></td>
                                <td><center><strong>De 85 a 95 años</strong></center></td>
                                <td><center><strong>Sin edad</strong></center></td>
                              </tr>
                            </thead>
                            <tbody>
                              <?php while($row = pg_fetch_array($datos)){ ?>
                              <tr bgcolor="#DAD2D9">
                                <td><center><?php echo $row['vin_descripcion']; ?></center></td>
                                <td><center><?php if($row['de_14_a_24'] != NULL) echo $row['de_14_a_24']; else echo 0;?></center></td>
                                <td><center><?php if($row['de_25_a_34'] != NULL) echo $row['de_25_a_34']; else echo 0;?></center></td>
                                <td><center><?php if($row['de_35_a_44'] != NULL) echo $row['de_35_a_44']; else echo 0;?></center></td>
                                <td><center><?php if($row['de_45_a_54'] != NULL) echo $row['de_45_a_54']; else echo 0;?></center></td>
                                <td><center><?php if($row['de_55_a_64'] != NULL) echo $row['de_55_a_64']; else echo 0;?></center></td>
                                <td><center><?php if($row['de_65_a_74'] != NULL) echo $row['de_65_a_74']; else echo 0;?></center></td>
                                <td><center><?php if($row['de_75_a_84'] != NULL) echo $row['de_75_a_84']; else echo 0;?></center></td>
                                <td><center><?php if($row['de_85_a_150'] != NULL) echo $row['de_85_a_150']; else echo 0;?></center></td>
                                <td><center><?php if($row['no_contesta'] != NULL) echo $row['no_contesta']; else echo 0;?></center></td>
                              </tr>
                            <?php } ?>
                          </tbody>
                        </table>
...
<script type="text/javascript">
      $('#buscar').on('click', function(event) {
        ...
        if (fecha1 == '') {
          ...
          $.ajax({
            url: '<?php echo URL; ?>edadvinculo/edad_vinculo',
            type: 'POST',
            dataType: 'html',
 ...
 <script>$(document).ready(function() {
    ...
    {
      extend: 'excelHtml5',
      title: 'Edad - vínculo <?php if($_POST){ echo 'desde '.date("d/m/Y", strtotime($_POST['fecha1'])).' hasta '.date("d/m/Y", strtotime($_POST['fecha2'])); } ?>',
      className: 'btn',
      text: "Excel"
  },
  {
...
{
  extend: 'print',
  title: '<H2>Edad - vínculo <?php if($_POST){ echo 'desde '.date("d/m/Y", strtotime($_POST['fecha1'])).' hasta '.date("d/m/Y", strtotime($_POST['fecha2'])); } ?></H2><H5>Registro Único de Casos de Violencia contra las Mujeres (RUCVM)</H5><BR/>',
  className: 'btn',
  text: "Imprimir"
},
 {
