...
<script type="text/javascript">
  window.onload=function(){
        document.getElementById("op48").style.color = 'white';
      }
    </script>
    <script type="text/javascript">
  $(function () {
...
Highcharts.chart('container', {
  ...
  title: {
    text: 'Casos de violencia contra las mujeres registrados e informados, según la cantidad de tipos de violencia, en la provincia de Tucumán. Período: <?php echo date("d/m/Y", strtotime($_POST['fecha1'])); ?> - <?php echo date("d/m/Y", strtotime($_POST['fecha2'])); ?>.',
   style: { 
         fontSize: '14px', 
  ...
  series: [{
    ...
    data: [
    {
      name: '1 tipo de violencia',
      y: <?php echo $row['puna']; ?>,
      t: <?php echo $t1[0]; ?>
    },
    {
      name: '2 tipos de violencia',
      y: <?php echo $row['pdos']; ?>,
      t: <?php echo $t2[0]; ?>
    },
    {
      name: '3 tipos de violencia',
      y: <?php echo $row['ptres']; ?>,
      t: <?php echo $t3[0]; ?>
    },
    {
      name: '4 tipos de violencia',
      y: <?php echo $row['pcuatro']; ?>,
      t: <?php echo $t4[0]; ?>
    },
    {
      name: '5 tipos de violencia',
      y: <?php echo $row['pcinco']; ?>,
      t: <?php echo $t5[0]; ?>
    },
    {
      name: '6 tipos de violencia',
      y: <?php echo $row['pseis']; ?>,
      t: <?php echo $t6[0]; ?>
    },
    {
      name: 'No informado',
      y: <?php echo $row['pninguna']; ?>,
      t: <?php echo $t0[0]; ?>
    }
    ]
  }]
            ...
            <div class="card-body">
              <form id="enviar" name="enviar" role="form" class="form-horizontal" enctype="multipart/form-data"  method="post" action="">
                  ...
                  <div class="form-row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <div class="form-label-group">
                        <b>Cantidad de tipos de violencia <?php if($_POST){ echo 'desde '.date("d/m/Y", strtotime($_POST['fecha1'])).' hasta '.date("d/m/Y", strtotime($_POST['fecha2'])); } ?></b>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="table-responsive">
                          <table id="tablaCanViolencia" name="tabla" class="table table-bordered col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <thead>
                              <tr style="background-color: #b3434375">  
                                <td><center><strong>Cantidad de tipos de violencia</strong></center></td>
                                <td><center><strong>Fichas</strong></center></td>
                              </tr>
                            </thead>
                            <tbody>
                              <tr bgcolor="#DAD2D9">
                                <td><center>1 tipo de violencia</center></td>
                                <td><center><?php echo $t1[0]; ?></center></td>
                              </tr>
                              <tr bgcolor="#DAD2D9">
                                <td><center>2 tipos de violencia</center></td>
                                <td><center><?php echo $t2[0]; ?></center></td>
                              </tr>
                              <tr bgcolor="#DAD2D9">
                                <td><center>3 tipos de violencia</center></td>
                                <td><center><?php echo $t3[0]; ?></center></td>
                              </tr>
                              <tr bgcolor="#DAD2D9">
                                <td><center>4 tipos de violencia</center></td>
                                <td><center><?php echo $t4[0]; ?></center></td>
                              </tr>
                              <tr bgcolor="#DAD2D9">
                                <td><center>5 tipos de violencia</center></td>
                                <td><center><?php echo $t5[0]; ?></center></td>
                              </tr>
                              <tr bgcolor="#DAD2D9">
                                <td><center>6 tipos de violencia</center></td>
                                <td><center><?php echo $t6[0]; ?></center></td>
                              </tr>
                              <tr bgcolor="#DAD2D9">
                                <td><center>No informado</center></td>
                                <td><center><?php echo $t0[0]; ?></center></td>
                              </tr>
                          </tbody>
                        </table>
                  </div>
   ...
   <script type="text/javascript">
      $('#buscar').on('click', function(event) {
        ...
        if (fecha1 == '') {
          ...
          $.ajax({
            url: '<?php echo URL; ?>canviolencias/can_violencia',
            type: 'POST',
            dataType: 'html',
    ...
    {
      extend: 'excelHtml5',
      title: 'Cantidad de tipos de violencia <?php if($_POST){ echo 'desde '.date("d/m/Y", strtotime($_POST['fecha1'])).' hasta '.date("d/m/Y", strtotime($_POST['fecha2'])); } ?>',
      className: 'btn',
      text: "Excel"
  },
  {
...
{
  extend: 'print',
  title: '<H2>Cantidad de tipos de violencia <?php if($_POST){ echo 'desde '.date("d/m/Y", strtotime($_POST['fecha1'])).' hasta '.date("d/m/Y", strtotime($_POST['fecha2'])); } ?></H2><H5>Registro Único de Casos de Violencia contra las Mujeres (RUCVM)</H5><BR/>',
  className: 'btn',
  text: "Imprimir"
},
 {
