...
//use Models\Seccion as Seccion;
	...
	class educonsultanteController{
            
            private $educonsultante;
            private $ficha1;
            //private $seccion;
            ...
            public function edu_consultante(){
                ...
                if(!$_POST){
                    ...
                    if($_SESSION['idinstitucion'] == 12){
                        $datos = $this->ficha1->eduConsultanteDep();    
                    }else{
                        $datos = $this->ficha1->eduConsultante();
                    }
                    return $datos;
                }
	        }
}
    $ficha1 = new educonsultanteController();
?>