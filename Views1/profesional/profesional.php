  ...
  <head>
    ...
    <script type="text/javascript">
        window.onload=function(){
          document.getElementById("op35").style.color = 'white';
        }
    </script> 
  </head>
                  ...
                  <div class="form-row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <div class="form-label-group">
                        <b>Fichas por profesional <?php if($_POST){ echo 'desde '.date("d/m/Y", strtotime($_POST['fecha1'])).' hasta '.date("d/m/Y", strtotime($_POST['fecha2'])); } ?></b>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <?php
                      ...
                      <div class="col-xs-6 col-sm-4 col-md-4 col-lg-5">
                        ...
                        <?php if ($filas > 0) {?>
                          ...
                          <table id="tablaProfesional" name="tabla" class="table table-bordered col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <thead>
                              <tr style="background-color: #b3434375">  
                                <td><center><strong>Profesional</strong></center></td>
                            ...
                            <tbody>
                              ...
                              <tr bgcolor="#DAD2D9">
                                <td><center><?php echo $row['profesional']; ?></center></td>
                                <td><center><?php echo $row['fichas']; ?></center></td>
...
<script type="text/javascript">
      $('#buscar').on('click', function(event) {
        ...
        if (fecha1 == '') {
          ...
          $.ajax({
            url: '<?php echo URL; ?>profesional/profesional',
            type: 'POST',
            dataType: 'html',
...
{
  extend: 'print',
  title: 'Fichas Profesional<H5>Registro Único de Casos de Violencia contra las Mujeres (RUCVM)</H5><BR/>',
  className: 'btn',
  text: "Imprimir"
},
 {
