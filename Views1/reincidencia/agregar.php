...
<html lang="en">
  ...
  <head>
    ...
    <title>Nueva ficha de reincidencia</title>
    ...
    <div id="content-wrapper" style="background-color: #e9e2e8">
      <div class="container-fluid">
        <div class="card col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="card-header">Nueva reincidencia</div>
            <div class="card-body">
              <form role="form" class="form-horizontal" enctype="multipart/form-data"  method="post" action="">
                  ...
                  <div class="form-row">
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                      <div class="form-label-group">
                        <input type="date" id="re_fecha" name="re_fecha" class="form-control" placeholder="Fecha de seguimiento" required="required" autofocus="autofocus" value="" onfocusout="validarFecha(this.value);">
                        <label for="re_fecha"><b>Fecha de reincidencia(*)</b></label>
                      </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                    <div class="form-label-group">
                      <input type="time" id="re_horario" name="re_horario" class="form-control" placeholder="Horario" required="required" autofocus="autofocus" value="">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="form-row">
                          <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                            <div class="form-label-group">
                              <input  type="number" id="per_dni" name="per_dni" class="form-control" placeholder="DNI Consultante" min="1000000" max="99999999" required="required" autofocus="autofocus" value="<?php if(isset($row['per_dni']))echo $row['per_dni']; ?>" disabled>
                            <label for="per_dni"><small>DNI Consultante(*)</small></label>
                          </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                            <div class="form-label-group">
                              <input  type="hidden" id="r_per_dni" name="r_per_dni" class="form-control" placeholder="DNI Consultante" min="1000000" max="99999999" required="required" autofocus="autofocus" value="<?php if(isset($row['per_dni']))echo $row['per_dni']; ?>">
                          </div>
                        </div>
                    </div>
                  </div>
                      ...
                      <div class="form-group">
                        <div class="form-row">
                          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                            <div class="form-label-group">
                              <input type="number" id="idsexo" name="idsexo" class="form-control" placeholder="Sexo" min="0" max="2" required="required" value="<?php if(isset($row)){ echo $row['idsexo']; } ?>" onkeyup="this.value=Numeros(this.value)" onfocusout="habilitar1(this.value);">
                      ...
                      <div class="form-group">
                        <div class="form-row">
                          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                            <div class="form-label-group">
                              <input type="number" id="idestadocivil" name="idestadocivil" class="form-control" placeholder="Estado civil" maxlength="1"  autofocus="autofocus" min="1" max="6" onkeyup="this.value=Numeros2(this.value)" value="<?php if(isset($row)){ echo $row['idestadocivil']; } ?>">
               ...
               <div class="form-group">
                  <div class="form-row">
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                      <div class="form-label-group">
                        <input type="date" id="fec_agresion" name="fec_agresion" class="form-control" placeholder="Fecha agresión" value= "<?php if (isset($row['fec_agresion'])) echo $row['fec_agresion']; ?>" required="required">
                        <label for="fec_agresion"><b>Fecha agresión(*)</b></label>
                      </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                      <div class="form-label-group">
                        <input type="time" id="mo_agresion" name="hora_agresion" class="form-control" placeholder="Hora agresión" value= "<?php if (isset($row['hora_agresion'])) echo $row['hora_agresion']; ?>" >
                ...
                <div class="form-group">
                  <div class="form-row">
                      <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                      <div class="form-label-group">
                        <input type="number" id="mo_agresion" name="idmomento" class="form-control" placeholder="Momento del día" min="1" max="5" onkeyup="this.value=Numeros4(this.value)" value= "<?php if (isset($row['idmomento'])) echo $row['idmomento']; ?>" required="required">
                        <label for="idmomento"><small><b>Momento de agresión(*)</b></small></label>
                      </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                      <div class="form-label-group">
                        <input type="number" id="p_menores" name="p_menores" class="form-control" placeholder="Presencia de menores" onkeyup="this.value=Numeros3(this.value)" value= "<?php if (isset($row['p_menores'])) echo $row['p_menores']; ?>" required="required" autofocus="autofocus">
                  ...
                  <div class="form-group">
                    <div class="form-row">
                      <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                        <div class="form-label-group">
                          <input type="number" id="disponelugar" name="disponelugar" class="form-control" placeholder="Dispone de lugar" onkeyup="this.value=Numeros5(this.value)" value= "<?php if (isset($row['disponelugar'])) echo $row['disponelugar']; ?>" autofocus="autofocus" min="1" max="2">
                  ...
                  <div class="form-group">
                    <div class="form-row">
                      <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                        <div class="form-label-group">
                          <input type="number" id="salud" name="idsalud" class="form-control" placeholder="Cobertura de salud" onkeyup="this.value=Numeros6(this.value)" value= "<?php if (isset($row['idsalud'])) echo $row['idsalud']; ?>" autofocus="autofocus" min="1" max="3">
                  ...
                  <div class="form-group">
                    <div class="form-row">
                      <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                        <div class="form-label-group">
                          <input type="number" id="idvivienda" name="idvivienda" class="form-control" onkeyup="this.value=Numeros7(this.value)" value= "<?php if (isset($row['idvivienda'])) echo $row['idvivienda']; ?>" placeholder="Tenencia de vivienda" autofocus="autofocus" min="1" max="7">
                          ...
                          <div class="form-row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                              <div class="selector-profesional">
                                ...
                                <input  type="hidden" id="idprofesional1" name="idprofesional1" value="<?php if ($row['idprofesional']){ echo $row['idprofesional'];}else{echo '+';} ?>">
                ...
                <div class="form-group">
                  <div class="form-row">
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                      <div class="form-label-group">
                        <input type="number" id="v_fisica" name="v_fisica" class="form-control" placeholder="Violencia física" value= "<?php if (isset($row['v_fisica'])) echo $row['v_fisica']; ?>" required="required" autofocus="autofocus" min="1" max="2" onkeyup="this.value=Numeros5(this.value)">
                        <label for="v_fisica"><small><b>Violencia física(*)</b></small></label>
                      </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                      <div class="form-label-group">
                        <input type="number" id="v_psicologica" name="v_psicologica" class="form-control" placeholder="Violencia verbal/psicologica/emocional" value= "<?php if (isset($row['v_psicologica'])) echo $row['v_psicologica']; ?>" required="required" min="1" max="2" onkeyup="this.value=Numeros5(this.value)">
                        <label for="v_psicologica"><small><b>Violencia verbal/psicologica/emocional(*)</b></small></label>
                      </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                        <div class="form-label-group">
                          <input type="number" id="v_sexual" name="v_sexual" class="form-control" placeholder="Violencia sexual/reproductiva" required="required" value= "<?php if (isset($row['v_sexual'])) echo $row['v_sexual']; ?>" autofocus="autofocus" min="1" max="2" onkeyup="this.value=Numeros5(this.value)">
               ...
               <div class="form-group">
                  <div class="form-row">
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                        <div class="form-label-group">
                          <input type="number" id="v_economica" name="v_economica" class="form-control" placeholder="Violencia económica/patrimonial" value= "<?php if (isset($row['v_economica'])) echo $row['v_economica']; ?>" required="required" autofocus="autofocus" min="1" max="2" onkeyup="this.value=Numeros5(this.value)">
                          <label for="v_economica"><small><b>Violencia económica/patrimonial(*)</b></small></label>
                        </div>
                      </div>
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                      <div class="form-label-group">
                        <input type="number" id="v_parsocial" name="v_parsocial" class="form-control" placeholder="Restricción participación social" value= "<?php if (isset($row['v_parsocial'])) echo $row['v_parsocial']; ?>" min="1" max="2" onkeyup="this.value=Numeros5(this.value)" required="required">
                        <label for="v_parsocial"><small><b>Restricción participación social(*)</b></small></label>
                      </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                      <div class="form-label-group">
                        <input type="number" id="v_simbolica" name="v_simbolica" class="form-control" placeholder="Violencia simbólica" value= "<?php if (isset($row['v_simbolica'])) echo $row['v_simbolica']; ?>" min="1" max="2" onkeyup="this.value=Numeros5(this.value)" required="required">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="form-row">
                      <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                        <div class="form-label-group">
                          <input type="number" id="co_obstaculo" name="co_obstaculo" class="form-control" placeholder="Impedimento/obstaculación del contacto con los hijos" value= "<?php if (isset($row['co_obstaculo'])) echo $row['co_obstaculo']; ?>" autofocus="autofocus" min="1" max="2" onkeyup="this.value=Numeros5(this.value)">
                          <label for="co_obstaculo"><small>Impedimento del contacto con los hijos</small></label>
                        </div>
                      </div>
                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-3">
                          <div class="form-label-group">
                            <input type="number" id="co_econo" name="co_econo" class="form-control" placeholder="Limitación de recursos económicos" value= "<?php if (isset($row['co_econo'])) echo $row['co_econo']; ?>" autofocus="autofocus" min="1" max="2" onkeyup="this.value=Numeros5(this.value)">
                  ...
                  <div class="form-row">
                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                      <div class="form-label-group">
                        <input type="number" id="re_denuncia" name="re_denuncia" class="form-control" placeholder="¿Realizó/ara denuncia?" onfocusout="habilitar(this.value);" min="1" max="2" required="required" onkeyup="this.value=Numeros5(this.value)">
                        <label for="re_denuncia"><small><b>¿Realizó/ara denuncia?(*)</b></small></label>
                      </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                      <div class="form-label-group">
                        <input type="text" id="re_donde" name="re_donde" class="form-control" placeholder="¿Donde?" value= "" autofocus="autofocus">
                        <label for="re_donde"><small>¿Donde?</small></label>
                      </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                      <div class="form-label-group">
                        <input type="number" id="idfiscalia" name="idfiscalia" class="form-control" placeholder="Fiscalía Nº" value= "">
                        <label for="idfiscalia"><small>Fiscalía Nº</small></label>
                      </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                      <div class="form-label-group">
                        <input type="text" id="re_porque" name="re_porque" class="form-control" placeholder="¿Por qué?" value= "" autofocus="autofocus">
                      ...
                      <div class="form-group">
                        <div class="form-row">
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-label-group">
                              <textarea class="form-control" rows="5" id="re_observacion" name="re_observacion" placeholder="Escriba alguna observación..." value=""></textarea> 
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>¿Desea guardar los datos de la ficha de reincidencia?</p>
      </div>
