        ...
        <button type="button" class="btn btn-primary">Save changes</button>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTableOvd" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>Archivo</th>
                  ...
                  <tbody><?php while($row = pg_fetch_assoc($datos)){ ?>
                      <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo URL; ?>baseovd/finalizar/<?php echo $row['idbaseovd']; ?>" class="btn btn-success btn-md" data-toggle="tooltip" data-placement="top" title="Finalizar"><i class="fas fa-check"></i></a></td>
                            <?php }else{ echo ' ';} ?>
