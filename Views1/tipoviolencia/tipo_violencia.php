...
Highcharts.chart('container', {
  <?php
      $row = pg_fetch_array($datos);
        $fisica[] = $row['fisica'];
        $psicologica[] = $row['psicologica'];
        $sexual[] = $row['sexual'];
        $simbolica[] = $row['simbolica']; 
        $economica[] = $row['economica'];
        $parsocial[] = $row['parsocial'];
        $pfisica[] = $row['pfisica'];
        $ppsicologica[] = $row['ppsicologica'];
        $psexual[] = $row['psexual'];
        $psimbolica[] = $row['psimbolica'];
        $peconomica[] = $row['peconomica'];
        $pparsocial[] = $row['pparsocial']; 
  ...
  title: {
    text: 'Casos de violencia contra las mujeres registrados e informados, según el tipo de violencia, en la provincia de Tucumán. Período: <?php echo date("d/m/Y", strtotime($_POST['fecha1'])); ?> - <?php echo date("d/m/Y", strtotime($_POST['fecha2'])); ?>.',
   style: { 
         fontSize: '14px', 
  ...
  series: [{
    ...
    data: [
    {
      ...
      y: <?php echo $row['pfisica']; ?>,
      t: <?php echo $fisica[0]; ?>
    },
    {
      name: 'Violencia psicológica',
      y: <?php echo $row['ppsicologica']; ?>,
      t: <?php echo $psicologica[0]; ?>
    },
    {
      name: 'Violencia sexual',
      y: <?php echo $row['psexual']; ?>,
      t: <?php echo $sexual[0]; ?>
    },
    {
      name: 'Violencia economica',
      y: <?php echo $row['peconomica']; ?>,
      t: <?php echo $economica[0]; ?>
    },
    {
      name: 'Restricción a la participación social',
      y: <?php echo $row['pparsocial']; ?>,
      t: <?php echo $parsocial[0]; ?>
    },
    {
      name: 'Violencia simbolica',
      y: <?php echo $row['psimbolica']; ?>,
      t: <?php echo $simbolica[0]; ?>
    }
    ]
  }]
});
                  ...
                  <div class="form-row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <div class="form-label-group">
                        <b>Tipos de violencia <?php if($_POST){ echo 'desde '.date("d/m/Y", strtotime($_POST['fecha1'])).' hasta '.date("d/m/Y", strtotime($_POST['fecha2'])); } ?></b>
                      </div>
                    </div>
                  </div>
                </div>
                          ...
                          <table id="tablaTipoViolencia" name="tabla" class="table table-bordered col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <thead>
                              <tr style="background-color: #b3434375">  
                                <td><center><strong>Tipo de violencia</strong></center></td>
                            ...
                            <tbody>
                              <tr bgcolor="#DAD2D9">
                                ...
                                <td><center><?php echo $fisica[0]; ?></center></td>
                              </tr>
                              <tr bgcolor="#DAD2D9">
                                <td><center>Violencia psicológica</center></td>
                                <td><center><?php echo $psicologica[0]; ?></center></td>
                              </tr>
                              <tr bgcolor="#DAD2D9">
                                <td><center>Violencia sexual</center></td>
                                <td><center><?php echo $sexual[0]; ?></center></td>
                              </tr>
                              <tr bgcolor="#DAD2D9">
                                <td><center>Violencia económica</center></td>
                                <td><center><?php echo $economica[0]; ?></center></td>
                              </tr>
                              <tr bgcolor="#DAD2D9">
                                <td><center>Restricción a la participación social</center></td>
                                <td><center><?php echo $parsocial[0]; ?></center></td>
                              </tr>
                              <tr bgcolor="#DAD2D9">
                                <td><center>Violencia simbólica</center></td>
                                <td><center><?php echo $simbolica[0]; ?></center></td>
                              </tr>
                          </tbody>
                        </table>
                  </div>
   ...
   <script type="text/javascript">
      $('#buscar').on('click', function(event) {
        ...
        if (fecha1 == '') {
          ...
          $.ajax({
            url: '<?php echo URL; ?>tipoviolencia/tipo_violencia',
            type: 'POST',
            dataType: 'html',
    ...
    {
      extend: 'excelHtml5',
      title: 'Casos de violencia contra las mujeres registrados e informados, según el tipo de violencia, en la provincia de Tucumán. Período: <?php echo date("d/m/Y", strtotime($_POST['fecha1'])); ?> - <?php echo date("d/m/Y", strtotime($_POST['fecha2'])); ?>',
      className: 'btn',
      text: "Excel"
  },
  {
...
{
  extend: 'print',
  title: '<H2>Casos de violencia contra las mujeres registrados e informados, según el tipo de violencia, en la provincia de Tucumán. Período: <?php echo date("d/m/Y", strtotime($_POST['fecha1'])); ?> - <?php echo date("d/m/Y", strtotime($_POST['fecha2'])); ?></H2><H5>Registro Único de Casos de Violencia contra las Mujeres (RUCVM)</H5><BR/>',
  className: 'btn',
  text: "Imprimir"
},
 {
