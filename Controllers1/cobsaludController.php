...
class cobsaludController{
    ...
    public function cobertura_consultante(){
        ...
        if(!$_POST){
            ...
            if($_SESSION['idinstitucion'] == 12){
                $datos = $this->ficha->coberturaSaludDep();    
            }else{
                $datos = $this->ficha->coberturaSalud();
            }
            return $datos;
        }
    }
